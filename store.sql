...
(5, '哈利波特', 'J.K.羅琳', '在世界的另一個角落裡，有一個神秘的國度，裡面住滿了巫師，貓頭鷹是他們的信差，飛天掃帚是交通工具，西洋棋子會思考，幽靈頑皮鬼滿天飛，畫像裡的人還會跑出來串門子。', 100, 'magicstone.jfif', '2019-08-15 17:20:04', 10),
(8, '敦克爾克大撤退', '華特‧勞德', '一九四○年五月，一場史上最大的撤退行動扭轉了第二次世界大戰的未來。', 200, '4.jpg', '2019-08-12 14:06:14', 0),
(9, '斜陽', '太宰治', '描寫戰後混亂苦悶的社會中，一個貴族家庭的沒落過程，恰如太陽西沉', 200, 'getImage.jpg', '2019-08-15 12:28:06', 12),
...
(14, '地獄變', '芥川龍之介', '《地獄變》是融古鑄今的歷史小說，以畫師良秀奉命完成「地獄變相圖」為經，再以良秀之女的遭遇為緯，織就一幅金碧輝煌太平盛世的浮世繪。', 100, 'getImage (4).jpg', '2019-08-15 17:11:42', 20),
(15, '巴黎和會', '瑪格蕾特．麥克米蘭', '驕傲、自信、富庶的歐洲在戰後將自己撕扯得四分五裂，各國領袖們因此齊聚巴黎。', 150, 'getImage (5).jpg', '2019-08-15 17:16:06', 10);
...
(1, '111', '698d51a19d8a121ce581499d7b701668', '111@mail.com', '83741', 0),
...
(38, '111', '斜陽', 200, 2, 400, '2019-08-15 12:28:06', '未出貨');
...
--
ALTER TABLE `book`
  MODIFY `bookId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- 使用資料表自動增長(AUTO_INCREMENT) `cart`
--
ALTER TABLE `cart`
  MODIFY `cartId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
