...
$orderBookArrays = $useCommonMethod->useOrderBookTable->searchUserOrderLimit($orderSearch, $useCommonMethod->account, $page, $count);
$searchAllCount = $useCommonMethod->useOrderBookTable->searchUserOrderCount($useCommonMethod->account, $orderSearch);
