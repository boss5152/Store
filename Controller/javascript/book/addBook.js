$(document).ready(function () {
    ...
    $("#addBookName").keyup(function () {
        ...
        checkAddBookBtn(addBookNameOk, addBookAuthorOk, addBookInfoOk, addBookPriceOk);
    });
...
//新增商品可不可以按
function checkAddBookBtn(addBookNameOk, addBookAuthorOk, addBookInfoOk, addBookPriceOk) {
    if ((addBookNameOk === true) && (addBookAuthorOk === true) && (addBookInfoOk === true) && (addBookPriceOk === true)) {
